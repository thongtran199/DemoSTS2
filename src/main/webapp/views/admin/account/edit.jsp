...
<body class="hold-transition sidebar-mini layout-fixed">
						...
						<div class="col-sm-8">
							...
							<div class="form-group">
								<label for="">fullName</label> <input type="text"
									class="form-control" id="fullName" placeholder="" value="${user.fullName}"><input
									type="hidden" id="IDuser" value="${user.userID}" /><input
									type="hidden" id="oldavt" value="${user.image}" />
							</div>
						</div>
						<div
							...
							<div class="form-group"
								...
								<img src="files/imageuser/${user.image}"
						...
						<div class="col-sm-4 ">
							<div class="form-group">
								<label for="">userName</label> <input type="text"
									class="form-control" id="userName" placeholder="" value="${user.userName}">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								<label for="">password</label> <input type="text"
									class="form-control" id="password" placeholder="" value="${user.password}">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label for="">telNumber</label> <input type="text"
									class="form-control" id="telNumber" placeholder="" value="${user.telNumber}">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<label for="">shipAddress</label> <input type="text"
									class="form-control" id="shipAddress" placeholder="" value="${user.shipAddress}">
							</div>
						</div>
												<div class="col-sm-6">
							<div class="form-group">
	...
	$("#submitBtn").click(function () {
		 var url = "http://localhost:8080/DemoSTS/adaccount?action=edit";
	    ...
	    formData.append('oldavt', $("#oldavt").val());
