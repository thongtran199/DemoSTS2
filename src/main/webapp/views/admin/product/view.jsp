...
<%@ include file="/common/admin/header.jsp" %>
												...
												<table id="example1"
													...
													<thead>
														<tr>
															...
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1"
																aria-label="Platform(s): activate to sort column ascending">Supplier</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1"
													...
													<tbody>
														<c:forEach items="${products}" var="item" varStatus="loop">
															...
															<tr class="${rowClass}">
																...
																<td class="dtr-control sorting_1" tabindex="0">${item.supplier.companyName}</td>
																<td class="dtr-control sorting_1" tabindex="0">${item.category.categoryName}</td>
																...
																<td>
																	<div>
																		<button type="button"
																			...
																			onclick="editBtn('${item.productID}')">Sửa</button>
																		<button type="button"
																			class="btn btn-block btn-outline-danger btn-sm"
																			onclick="deleteBtn('${item.productID}')">Xóa</button>
																	</div>
																</td>
															</tr>
														</c:forEach>
  ...
  {
      const deleteURL = "http://localhost:8080/DemoSTS/adproduct?action=delete&id="+id;
  ...
  function editBtn(id)
  {
      const editURL = "http://localhost:8080/DemoSTS/adproduct?action=edit&id="+id;
      console.log(editURL);
